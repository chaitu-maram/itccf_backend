...
#     path('jobs/post/',          PostJobsView.as_view(),     name='post-jobs'),   # type: ignore
#     # called by Index.tsx JobGrid on mount
#     path('jobs/board/',         JobBoardView.as_view(),     name='job-board'),   # type: ignore
#     # employer dashboard helpers
#     path('jobs/my/',            EmployerJobsView.as_view(), name='my-jobs'),     # type: ignore
